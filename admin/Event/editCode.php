...
if (!isset($_SESSION['username'])) {
  ...
  if(in_array("5", $_SESSION['roleStaff'], true)){
    $id = $_REQUEST['id'];
    $select = mysqli_query($conn,"SELECT * from codediscount where id_code = '$id'");
    ...
    if(isset($_POST['codeEvent']) && isset($_POST['discountValue']) && isset($_POST['dateStart']) && isset($_POST['dateEnd'])){
         ...
         $sql = "UPDATE codediscount SET code_event = '$code', discount_value = '$value', date_start = '$dateStart', date_end = '$dateEnd' WHERE id_code = '$id'";
                    ...
                    <div class="card mb-4">
                                ...
                                <div class="card-body">
                                         <div class="form-group">
                                           ...
                                           <input type="text" class="form-control" id="codeEvent" name="codeEvent"  placeholder="Enter Code" value="<?php echo $row['code_event'];?>">
                                         ...
                                         <div class="form-group">
                                           ...
                                           <div class="detail-box_wrap">
                                               <div class="input-box">
                                                 ...
                                                 <input type="number" min="1" max="100" step="0.5" value="<?php echo $row['discount_value'];?>" id="my-input" readonly name="discountValue">
